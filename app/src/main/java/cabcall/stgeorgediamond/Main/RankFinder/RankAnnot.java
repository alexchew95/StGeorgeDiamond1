...
import cabcall.stgeorgediamond.MapContent.Annot;
...
public class RankAnnot extends Annot {
...
int PreviousYLocation;
	...
	public RankAnnot (RankItem item, Activity HostingActivity)
	{
		super(item.RankCoordinates, item.RankName, item.RankHours + " : " + item.RankAddress, HostingActivity);
		updateCalled = false;
		firstTime = true;
	}
	...
	public void draw(Canvas canvas, MapView mapView, boolean shadow)
	{
		...
		Drawable myImage = r.getDrawable(R.drawable.annotation_taxi_annotation); //Change to a rank annotation
